...
class MultilineShowcase_Widget extends WP_Widget {
	/**
	...
	public function __construct() {
		parent::__construct(
	 		'MultilineShowcase_Widget', // Base ID
			__('MultilineShowcase_Widget','oscpro'), // Name
			array( 'description' => __( 'A MultilineShowcase Widget', 'oscpro' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		// get the $term->term_taxonomy_id  推荐产品
		...
		woocommerce_get_template( 'widgets/multiline_showcase.php', array(
